  ...
  return (
    <div className="px-4 py-10">
      <div>
        ...
        <div className="flex items-center  space-x-3 border-b  py-3 cursor-pointer">
          <div className="w-12 h-12 rounded-full bg-slate-300 mt-4"/>
          <div>
            <p className="font-medium text-sm text-gray-700">Steve Jebs</p>
            <p className="font-medium text-xs text-gray-500 ">View profile &rarr;</p>
          </div>
        </div>
        <div className="mt-5">
